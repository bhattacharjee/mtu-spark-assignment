...
# FUNCTION my_model
# ------------------------------------------
def my_model(ssc, monitoring_dir, result_dir, longitude):
    # 1. Operation C1: textFileStream
    inputDStream = ssc.textFileStream(monitoring_dir)

    # 2. Operation T1: filter
    solutionDStream = inputDStream.filter(lambda line: len(line) > longitude)
    ...
    # 5. Operation A2: saveAsTextFiles
...
# FUNCTION create_ssc
# ------------------------------------------
def create_ssc(sc, time_step_interval, monitoring_dir, result_dir, longitude):
    ...
    my_model(ssc, monitoring_dir, result_dir, longitude)
...
if __name__ == '__main__':
    ...
    # 1.3. We specify the desired minimum length of the lines
    longitude = 15
