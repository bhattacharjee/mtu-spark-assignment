...
# FUNCTION my_model
# ------------------------------------------
def my_model(spark, monitoring_dir, time_step_interval, window_duration, sliding_duration):
...
def my_main(spark,
    ...
    dsw = my_model(spark, monitoring_dir, time_step_interval, window_duration, sliding_duration)
...
if __name__ == '__main__':
    ...
    source_dir = "FileStore/tables/3_Spark_Streaming_Libs/3_2_Structured_Streaming/my_dataset_redundant/"
