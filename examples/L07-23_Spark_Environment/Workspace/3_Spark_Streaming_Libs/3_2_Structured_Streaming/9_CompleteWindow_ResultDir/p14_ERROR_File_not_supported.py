...
# FUNCTION my_model
# ------------------------------------------
def my_model(spark, monitoring_dir, checkpoint_dir, result_dir, time_step_interval, window_duration, sliding_duration):
...
def my_main(spark,
    ...
    dsw = my_model(spark, monitoring_dir, checkpoint_dir, result_dir, time_step_interval, window_duration, sliding_duration)
