...
if __name__ == '__main__':
    ...
    ex_no = 2
    solution_file_name = f'./A02_ex{ex_no}_spark_structured_streaming.txt'
    student_file_name = f'/home/phantom/dev/mtu-spark-assignment/assignment2/my_code/A02_ex{ex_no}_spark_structured_streaming/output.txt'
