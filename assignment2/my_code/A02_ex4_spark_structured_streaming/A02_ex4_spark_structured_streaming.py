...
# ------------------------------------------
#
# NOTE: The parameters bucket_size and max_speed_accepted are not being used at all.
#       Just passing them to the function for consistency with Spark Streaming.
#       But, again, you do not need to use them at all.
#
def my_model(spark,
             monitoring_dir,
             checkpoint_dir,
             time_step_interval,
             bucket_size, # <--- Not being used at all
             max_speed_accepted, # <--- Not being used at all
             day_picked
            ):
...
if __name__ == '__main__':
    ...
    source_dir = "FileStore/tables/6_Assignments/A02_ex4_micro_dataset_1/"
    #source_dir = "FileStore/tables/6_Assignments/A02_ex4_micro_dataset_2/"
